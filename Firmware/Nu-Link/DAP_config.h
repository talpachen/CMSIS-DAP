...
#include "NUC100Series.h"                            // Debug Unit Cortex-M Processor Header File
...
/* Board : Nu-Link-Me V2.0
HEADER----------IO------JTAG--------SWD---------CDC-UART----
ICEJP2.5		PC9		TCK			SWCLK
ICEJP2.3		PC10	TMS			SWDIO
TX1.1/ICEJP2.8	PB1		TDI						TXD
RX1.1/ICEJP2.10	PB0		TDO						RXD
VCOM1.1			PE5		nTRST
ICEJP2.7		PC8		nRESET		nRESET
ICEJP2.9				GND			GND			GND
*/
...
static __INLINE void PORT_JTAG_SETUP (void) {
	GPIO_SetMode(PIN_TCK_SWCLK_PORT, PIN_TCK_SWCLK_PIN, GPIO_PMD_OUTPUT);
	GPIO_SetMode(PIN_TMS_SWDIO_PORT, PIN_TMS_SWDIO_PIN, GPIO_PMD_OUTPUT);
	GPIO_SetMode(PIN_TDI_TXD_PORT, PIN_TDI_TXD_PIN, GPIO_PMD_OUTPUT);
	GPIO_SetMode(PIN_NTRST_PORT, PIN_NTRST_PIN, GPIO_PMD_OUTPUT);
	GPIO_SetMode(PIN_NRESET_PORT, PIN_NRESET_PIN, GPIO_PMD_OUTPUT);

	GPIO_SetMode(PIN_TDO_RXD_PORT, PIN_TDO_RXD_PIN, GPIO_PMD_INPUT);
}
...
static __INLINE void PORT_SWD_SETUP (void) {
	...
	GPIO_SetMode(PIN_TDI_TXD_PORT, PIN_TDI_TXD_PIN, GPIO_PMD_INPUT);
	GPIO_SetMode(PIN_NTRST_PORT, PIN_NTRST_PIN, GPIO_PMD_INPUT);
	GPIO_SetMode(PIN_TDO_RXD_PORT, PIN_TDO_RXD_PIN, GPIO_PMD_INPUT);
}
...
static __INLINE void PORT_OFF (void) {
	GPIO_SetMode(PIN_TCK_SWCLK_PORT, PIN_TCK_SWCLK_PIN, GPIO_PMD_INPUT);
	GPIO_SetMode(PIN_TMS_SWDIO_PORT, PIN_TMS_SWDIO_PIN, GPIO_PMD_INPUT);
	GPIO_SetMode(PIN_TDI_TXD_PORT, PIN_TDI_TXD_PIN, GPIO_PMD_INPUT);
	GPIO_SetMode(PIN_NTRST_PORT, PIN_NTRST_PIN, GPIO_PMD_INPUT);
	GPIO_SetMode(PIN_NRESET_PORT, PIN_NRESET_PIN, GPIO_PMD_INPUT);
	GPIO_SetMode(PIN_TDO_RXD_PORT, PIN_TDO_RXD_PIN, GPIO_PMD_INPUT);
}
